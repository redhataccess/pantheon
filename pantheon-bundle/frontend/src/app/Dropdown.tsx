                ...
                <div className="pf-c-context-selector__menu">
                    <div>
                        <ul className="pf-c-context-selector__menu-list" role="menu">
                            <li role="none"><button className="pf-c-context-selector__menu-list-item" onClick={()=>this.changeSelection(this.dropdownItems[0])}>{this.dropdownItems[0]}</button></li>
                            <li role="none"><button className="pf-c-context-selector__menu-list-item" onClick={()=>this.changeSelection(this.dropdownItems[1])}>{this.dropdownItems[1]}</button></li>
                            <li role="none"><button className="pf-c-context-selector__menu-list-item" onClick={()=>this.changeSelection(this.dropdownItems[2])}>{this.dropdownItems[2]}</button></li>
                            <li role="none"><button className="pf-c-context-selector__menu-list-item" onClick={()=>this.changeSelection(this.dropdownItems[3])}>{this.dropdownItems[3]}</button></li>
                        </ul>
                    </div>
                </div>
            </div>      
