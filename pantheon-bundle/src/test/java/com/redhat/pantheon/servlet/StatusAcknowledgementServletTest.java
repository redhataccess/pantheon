...
public class StatusAcknowledgementServletTest {
    ...
    public void testAddAcknowledgement() throws ServletException, IOException {
        ...
        String resourceUuid = slingContext.resourceResolver()
                .getResource("/content/repositories/repo/entities/module/en_US/variants/test/released")
                .getValueMap()
                .get("jcr:uuid")
                .toString();
    ...
    public void testAddAcknowledgementWhenDraft() throws ServletException, IOException {
        ...
        slingContext.create()
                .resource("/content/repositories/repo/entities/module1/en_US",
                        "jcr:primaryType", "pant:moduleLocale");
        slingContext.create()
                .resource("/content/repositories/repo/entities/module1/en_US/variants/test/released",
                        "jcr:primaryType", "pant:moduleVersion");
        slingContext.create()
                .resource("/content/repositories/repo/entities/module1/en_US/variants/test/released/metadata",
                        "jcr:title", "A title",
                        "jcr:description", "A description");
        slingContext.create()
                .resource("/content/repositories/repo/entities/module1/en_US/variants/test/released/cached_html/jcr:content",
                        "jcr:data", testHTML);

        slingContext.resourceResolver().getResource("/content/repositories/repo/entities/module1/en_US").adaptTo(ModifiableValueMap.class)
                .put("draft", slingContext.resourceResolver().getResource("/content/repositories/repo/entities/module1/en_US/variants/test/released").getValueMap()
                        .get("jcr:uuid"));
        registerMockAdapter(Module.class, slingContext);
