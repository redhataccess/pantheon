...
. Optional: Choose one or more *Content types* as search filters. Options: *Concept*, *Procedure*, and *Reference*.  If you do not select any, items of all types will be returned.
