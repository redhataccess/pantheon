...
DEFAULT_REPOSITORY = getpass.getuser() + '_' + datetime.now().strftime('%Y-%m-%d_%H-%M-%S')
DEFAULT_USER = 'demo'
...
parser.add_argument('--repository', '-r', help='The name of the repository; this is a convenience for the user. If not specified, one will be autogenerated')
