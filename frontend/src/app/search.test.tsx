...
describe('Search tests', () => {
  test('should render default Search component', () => {
    const view = shallow(<Search {...fakeState} />);
    expect(view).toMatchSnapshot();
  });

  it('should render a Button', () => {
    const wrapper = mount(<Router><Search {...fakeState} /></Router>);
  ...
  it('test getRows function', () => {
    const wrapper = renderer.create(<Router><Search {...fakeState} /></Router>);
  ...
  test('newSearch() click event', () => {
    const wrapper = shallow(<Search {...fakeState} />);
