...
describe('Search tests', () => {
  const fakeProps: IAppState = {
    isNavOpen: false,
    username: 'demo'
  }
  test('should render default Search component', () => {
    const view = shallow(<Search {...fakeProps} />);
    expect(view).toMatchSnapshot();
  });

  it('should render a Button', () => {
    const wrapper = mount(<Router><Search {...fakeProps} /></Router>);
  ...
  it('test getRows function', () => {
    const wrapper = renderer.create(<Router><Search {...fakeProps} /></Router>);
  ...
  test('newSearch() click event', () => {
    const wrapper = shallow(<Search {...fakeProps} />);
